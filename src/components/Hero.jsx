    ...
    <section id="home" className="min-h-screen relative flex items-center pt-28 pb-16 lg:py-0 overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center text-center lg:text-left">
          ...
          {/* HD Laptop Image with Floating Icons */}
          <motion.div
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -left-2 sm:-left-6 top-1/4 sm:top-[20%] bg-white p-3 sm:p-4 rounded-2xl shadow-xl shadow-blue-900/5 border border-slate-100 z-20"
              title="React"
            >
              <svg width="32" height="32" viewBox="-11.5 -10.23174 23 20.46348" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 sm:w-10 sm:h-10">
            ...
            <motion.div 
              ...
              className="absolute -right-2 sm:-right-4 top-1/3 sm:top-[15%] bg-white p-3 sm:p-4 rounded-2xl shadow-xl shadow-cyan-900/5 border border-slate-100 z-20"
              title="Tailwind CSS"
            >
              <svg width="32" height="32" viewBox="0 0 24 24" fill="#06B6D4" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 sm:w-10 sm:h-10">
                <path d="M12.001 4.8c-3.2 0-5.2 1.6-6 4.8 1.2-1.6 2.6-2.2 4.2-1.8.913.228 1.565.89 2.288 1.624C13.666 10.618 15.027 12 18.001 12c3.2 0 5.2-1.6 6-4.8-1.2 1.6-2.6 2.2-4.2 1.8-.913-.228-1.565-.89-2.288-1.624C16.337 6.182 14.976 4.8 12.001 4.8zm-6 7.2c-3.2 0-5.2 1.6-6 4.8 1.2-1.6 2.6-2.2 4.2-1.8.913.228 1.565.89 2.288 1.624 1.177 1.194 2.538 2.576 5.512 2.576 3.2 0 5.2-1.6 6-4.8-1.2 1.6-2.6 2.2-4.2 1.8-.913-.228-1.565-.89-2.288-1.624C10.337 13.382 8.976 12 6.001 12z"/>
              </svg>
            </motion.div>

            {/* Laravel Icon (Bottom Right) */}
            <motion.div 
              animate={{ y: [6, -6, 6] }} 
              transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
              className="absolute right-4 sm:right-0 bottom-1/4 sm:bottom-[25%] bg-white p-3 sm:p-4 rounded-2xl shadow-xl shadow-red-900/5 border border-slate-100 z-20"
              title="Laravel"
            >
              <svg width="32" height="32" viewBox="0 0 24 24" fill="#FF2D20" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 sm:w-10 sm:h-10">
            ...
            <motion.div 
              ...
              className="absolute left-6 sm:left-2 bottom-1/3 sm:bottom-[15%] bg-white p-3 sm:p-4 rounded-2xl shadow-xl shadow-yellow-900/5 border border-slate-100 z-20"
              title="JavaScript"
            >
              <svg width="32" height="32" viewBox="0 0 24 24" fill="#F7DF1E" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 sm:w-10 sm:h-10">
            ...
            <motion.img 
              ...
              className="w-full max-w-[700px] h-auto drop-shadow-2xl z-10 mix-blend-multiply relative"
              onError={(e) => {
